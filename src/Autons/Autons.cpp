...
Auton leftA = "Left" + []() {
    flyTBH.setDisabled(true);
    flywheelNm.spinVolt(vex::forward, 100);
    intakeController.disable();
    s(30);
    flyTBH.setTargetSpeed(540);
...
Auton winPoint = "Win Point" + []() {
    ...
    wc.estimateStartPos(PVector(-62, 40), 90.21);
    wc.faceTarget({50.42, 58.82});
    s(3200);
    launchDisks(1000, 2);
