...
Button VariableConfig::confirm = Button(Brain, 0, 0, BRAIN_WIDTH / 2, BRAIN_HEIGHT, green, color(0, 200, 0), "Confirm");
Button VariableConfig::deny = Button(Brain, BRAIN_WIDTH / 2, 0, BRAIN_WIDTH / 2, BRAIN_HEIGHT, red, color(200, 0, 0), "Deny");
