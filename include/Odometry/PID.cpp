...
PIDF::PIDF(KVals vals, PIDF_Extension& mgr, double iCap, double iGrowthRange, double iZeroRange) : PIDF(vals, iCap, iGrowthRange, iZeroRange){
    manager.reset(&mgr);
}
PIDF::PIDF(double p, double i, double d, PIDF_Extension& mgr, double iCap, double iGrowthRange, double iZeroRange) : PIDF(p, i, d, 0.0, iCap, iGrowthRange, iZeroRange){
    manager.reset(&mgr);
}
PIDF::PIDF(double p, double i, double d, double f, PIDF_Extension& mgr, double iCap, double iGrowthRange, double iZeroRange) : PIDF(p, i, d, f, iCap, iGrowthRange, iZeroRange){
    manager.reset(&mgr);
}
//Constructors
